...
<head>
    ...
    <style>
        * {
        ...
        .accepted, .pending, .all, .available {
    ...
    <script>
        $(document).ready(function(){
            $(".filter-button").click(function(){
                var status = $(this).text(); // Get the status from the button text

                $.ajax({
                    url: 'fetch_rooms.php', // The PHP script
                    type: 'post',
                    data: {status: status}, // Send the status to the server
