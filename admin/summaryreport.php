...
<!-- Use Bootstrap button classes for a professional look -->
<button id="printButton" class="btn btn-primary" onclick="window.print()">Print this page</button>
...
$total_pending_profit = 0;
    ...
    echo "<style>
        ...
        .card-body {
            color: #000000; 
            font-size: 16px; /* Slightly larger font size for body */
        }
        .label {
            color: #000000; 
        }
        .watermark {
            ...
            transform: rotate(-30deg); /* Less rotation */
        ...
        @media print {
            ...
            body {
                ...
                border: 10px double #b39700; /* Outer golden border */
                padding: 10px; /* Space between the border and the content */
                box-sizing: border-box; /* Include padding and border in element's total width and height */
            }
            .summary-logo {
                display: block; /* Show when printed */
                width: 200px; /* Adjust as needed */
                margin: 0 auto; /* Center the logo */
            }
            .card {
                border: 1px solid black;
                padding: 20px; /* More padding for print */
            }
            .card-header, .card-body, .label {
                color: black !important;
                font-size: 19px; /* Further increase font size for print */
            }
            table {
                page-break-inside: avoid;
                border-collapse: collapse; /* Professional table style */
            }
            table, th, td {
                border: 1px solid black; /* Professional table style */
            }
        }
    </style>";
    ...
    echo "<img src='logo no bg.png' alt='Logo' class='summary-logo'>";
    
    echo "<h1 class='text-center mb-4'>Summary and Reports</h1>";
    
    // Add fewer watermarks across the page
    for ($i = 0; $i < 5; $i++) {
        for ($j = 0; $j < 3.5; $j++) {
            echo "<div class='watermark' style='top: " . ($i * 20) . "%; left: " . ($j * 25) . "%;'>Confidential</div>";
        }
    }
...
echo "</div>"; // End column
    ...
    echo "</div>"; // End column
        ...
        echo "<div class='col-md-6 mb-4'>";
        echo "<div class='card'>";
        echo "<div class='card-header bg-warning text-white'>Other Information</div>";
        echo "<div class='card-body'>";
        echo "<table class='table table-hover'>";
        echo "<thead class='thead-light'>";
        echo "<tr><th scope='col'>Payment Status</th><th scope='col'>Count</th></tr>";
        echo "</thead>";
        echo "<tbody>";
        echo "<tr><td>Full Payment</td><td>" . $fullPaymentCount . "</td></tr>";
        echo "<tr><td>Not Fully Paid</td><td>" . $notFullPaymentCount . "</td></tr>";


        echo "<thead class='thead-light'>";
        echo "<tr><th scope='col'>Payment Methods</th><th scope='col'>Count</th></tr>";
        echo "</thead>";
        echo "<tbody>";
        echo "<tr><td>Gcash</td><td>" . $gcashCount . "</td></tr>";
        echo "<tr><td>Paymaya</td><td>" . $paymayaCount . "</td></tr>";
        echo "<tr><td>Visa</td><td>" . $visaCount . "</td></tr>";

        echo "<thead class='thead-light'>";
        echo "<tr><th scope='col'>Reservation Hours</th><th scope='col'>Count</th></tr>";
        echo "</thead>";
        echo "<tbody>";
        echo "<tr><td>1 Hour</td><td>" . $oneHourCount . "</td></tr>";
        echo "<tr><td>3 Hours</td><td>" . $threeHoursCount . "</td></tr>";
        echo "<tr><td>6 Hours</td><td>" . $sixHoursCount . "</td></tr>";
        echo "<tr><td>12 Hours</td><td>" . $twelveHoursCount . "</td></tr>";
        echo "<tr><td>24 Hours</td><td>" . $twentyFourHoursCount . "</td></tr>";
        echo "</tbody>";
