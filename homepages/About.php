...
<html dir="ltr" lang="aa" class=" inside_page inside_page_header_design s_layout15 isFreePackage  ">
    <head>
        ...
        <!-- Regular Meta Info -->
        <title class="s123-js-pjax">About - Nase Hotel</title>
        <meta name="description" content="About - Nase Hotel" class="s123-js-pjax">
        ...
        <meta property="og:description" content="About - Nase Hotel" class="s123-js-pjax">
        <meta property="og:title" content="About - Nase Hotel" class="s123-js-pjax">
        <meta property="og:site_name" content="Nase Hotel" class="s123-js-pjax">
        <meta property="og:see_also" content="https://64436e4ca3853.site123.me" class="s123-js-pjax">
        <!-- Google+ Meta Info -->
        <meta itemprop="name" content="About - Nase Hotel" class="s123-js-pjax">
        <meta itemprop="description" content="About - Nase Hotel" class="s123-js-pjax">
        ...
        <meta name="twitter:title" content="About - Nase Hotel" class="s123-js-pjax">
        <meta name="twitter:description" content="About - Nase Hotel" class="s123-js-pjax">
...
@media only screen and (max-width: 300px) {
  .prev, .next,.text {font-size: 11px}
    ...
    <main>
            ...
            <img src="economy.png" style="width:100%">
            <div class="text">Economy</div>
            </div>

            <div class="mySlides fade">
            <div class="numbertext">2 / 3</div>
            <img src="Deluxe.png" style="width:100%">
            <div class="text">Deluxe</div>
            </div>

            <div class="mySlides fade">
            <div class="numbertext">3 / 3</div>
            <img src="premium.png" style="width:100%">
            ...
            <div class="right">
              <p style="text-align: justify; margin-left: 20px;">Chief Executive Officer</p>
              <h3 style="text-align: justify; margin: 20px;">Jazz Nase</h3>
              <p style="text-align: justify; text-indent: 50px; margin: 20px;"><b><i>"Success is not solely defined by financial gain. True success lies in the positive impact we make on our team, our customers, and our community. Strive to leave a lasting legacy of positive change."</b></i></p>
              <p style="text-align: justify; margin: 20px;">Nase Hotel, established on April 20, 2023, is the realization of the owner's dream to operate her own hotel. Starting with just five basic rooms, the journey to launch the business was challenging. Over the years, the hotel has expanded, earning the trust and support of numerous investors. Today, Nase Hotel proudly offers a total of 33 rooms, categorized into three types: 15 Economy, 10 Deluxe, and 8 Premium rooms.</p>
            </div>
        </section>
    </main>
