...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Check if there are errors and trigger SweetAlert if needed
    if (!empty($errors)) {
        echo "<script>
            Swal.fire({
                icon: 'error',
...
<script>
        // Your SweetAlert script block here
        <?php
        if (!empty($errors)) {
            echo "Swal.fire({
                icon: 'error',
...
<div class="placeholder">
    ...
    <div class="logo">
    <a href="home.php"><img class="centered-image" src="logoyata.svg" alt="Nase Hotel"></a>
...
<footer>
    <hr>
    <p>&copy; 2024 Nase Hotel. All Rights Reserved.</p>
</footer>
