...
<html dir="ltr" lang="aa" class=" inside_page inside_page_header_design s_layout15 isFreePackage  ">
    <head>
        ...
        <meta property="og:description" content="Pricing Table - Nase Hotel" class="s123-js-pjax">
        <meta property="og:title" content="Pricing Table - Nase Hotel" class="s123-js-pjax">
        ...
        <!-- Google+ Meta Info -->
        <meta itemprop="name" content="Pricing Table - Nase Hotel" class="s123-js-pjax">
        <meta itemprop="description" content="Pricing Table - Nase Hotel" class="s123-js-pjax">
        ...
        <meta name="twitter:title" content="Pricing Table - Nase Hotel" class="s123-js-pjax">
        <meta name="twitter:description" content="Pricing Table - Nase Hotel" class="s123-js-pjax">
  ...
  cursor: pointer;
    ...
    <main>
        <section class="roomContainer">
            <div class="top">
                <h1>Rooms</h1>
                <p style="text-align: justify;">Welcome to our comfortable and stylish hotel rooms, your home away from home. Our well-appointed room features modern amenities, a cozy bed, and a private bathroom. Whether you're traveling for business or leisure, you'll find everything you need for a relaxing stay. </p>
            </div>
            ...
            <div class="container">
                    ...
                    <img style="height: 250px; width: 350px  ;" src="premium.png" alt="premium Image">
                   </div>
                    <h1> premium</h1>
                    <p>up to PHP 4,000</p>
                    </div>
                ...
                <div class="containerDet">
                    ...
                    <h1>DETAILS</h1>
                    <p>2 Queen-size Bed</p>
                    <p>En-suite Bathroom</p>
                    <p>Entertainment System</p>
                    <p>Living Room</p>
                    <p>Mini-Fridge Service</p>
                    <p>24/7 Room Service</p>
                    <br>
                    <p>24 hours Php 4,000</p>
                    <p>12 hours Php 2,350</p>
                    <p>6 hours Php 1,250</p>
                    <p>3 hours Php 650</p>
                    </div>
                </div>
